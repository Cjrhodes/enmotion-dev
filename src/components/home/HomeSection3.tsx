          ...
          <div className="row align-items-end">
            <div className="col-lg-8">
              <div className="banner-txt">
                <h4 className="pc-title-left">
                  <CustomGsapTextSplit children="En Motion" />
                ...
                <h1 className="pc-title-left">
                  <CustomGsapTextSplit>
                   POWER <span className="color">IN</span>
                    <span className="offset"> Motion</span>
                  </CustomGsapTextSplit>
                </h1>
            ...
            <div className="col-lg-4">
              <motion.div
                ...
                ref={bannerImageRef}
              >
                <img src="img/tr.png" alt="image" className="responsive-image"/>
              </motion.div>
            </div>
          </div>
        </div>
